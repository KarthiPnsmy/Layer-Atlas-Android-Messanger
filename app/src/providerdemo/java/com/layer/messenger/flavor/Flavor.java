...
public class Flavor implements App.Flavor {
    ...
    //private final static String LAYER_APP_ID = "layer:///apps/staging/b6846d1e-1d93-11e6-9bf0-070002002f7c"; //atlas
    private final static String LAYER_APP_ID = "layer:///apps/staging/6e22ed88-2311-11e6-ab98-ada34e1b14cb"; //rajinikanth
    private final static String GCM_SENDER_ID = "52130574300";
